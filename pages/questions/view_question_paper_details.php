...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form action="download_question_list.php" method="post">
    <!-- Main content -->
...
$query = "
    SELECT question.questionID, question.questionText, question.gradeName, question.subjectName, question.status
    FROM question
    JOIN questionset ON FIND_IN_SET(question.questionID, questionset.quesIdList)
    WHERE questionset.quesSetId = $quesSetId
...
?>
              ...
              <!-- this div for generate pdf-->

              <div class="box-footer" align="middle">
               
                  <input type="hidden" name="qSetId" value="12">
                	<input type="hidden" name="qIdList" value="50">
                <!-- <a href="download_question_list.php/50" class='btn btn-info' name='50' formtarget="_blank">
			           Download Pdf
			          </a> -->
