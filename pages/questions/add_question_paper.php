 ...
 <?php include "menu.php"; ?>
      ...
      <form role="form" class="form-horizontal" action="add_question_logic.php" method="POST" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="tab-content" style="padding: 40px;">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
             <input type="text" class="form-control" name="quesSetName" id="quesSetName" placeholder="Question set name" value="" required="">
            </div>
          </div>
  ...
  <div class="col-sm-10">
    <select class="form-control select2" name="gradeName" id="gradeName" style="width: 100%;" required>
              ...
              <option value="6M.TECH">M.TECH</option>              
             </select>
            </div>
          </div>
  ...
  <div class="col-sm-10">
    <select class="form-control select2" name="subjectName" id="subjectName" style="width: 100%;" required>
               ...
               <option selected="selected" disabled="" data-select2-id="4">--Select--</option>
          ...
          <div class="form-group">
            <label for="quesSetName" class="col-sm-2 control-label">Semester</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" name="SemName" id="SemName" placeholder="" required>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" name="institute" id="institute" placeholder="" required>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="date" class="form-control" name="examDate" id="examDate" placeholder="" required>
            </div>
          </div>
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" name="totalMarks" id="totalMarks" placeholder="Total marks" required="">
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" name="marksPerQuestion" id="marksPerQuestion" placeholder="Marks per question" required="">
    </div>
</div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" name="examDuration" id="examDuration" required>
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <select class="form-control select2" name="status" id="status" style="width: 100%;" data-select2-id="status" tabindex="-1" aria-hidden="true">
              <option selected="selected" disabled="" data-select2-id="6">--Select--</option>
